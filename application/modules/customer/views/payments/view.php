                ...
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <img alt="Pembayaran order #<?php echo $data->order_number; ?>" class="img img-fluid"
                                src="<?php echo base_url('assets/uploads/payments/'. $data->picture_name); ?>">
                        </div>
                        <a href="<?php echo base_url('assets/uploads/payments/'. $data->picture_name); ?>">Pdf File</a>
                    </div>
                </div>
            </div>
        </div>
