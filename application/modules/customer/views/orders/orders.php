                ...
                <div class="table-responsive">
                    <table class="table table-striped m-0">
                        ...
                        <tr>
                            ...
                            <td><?php echo anchor('customer/orders/cetak_order/'. $order->id, 'Cetak Order'); ?>
                            </td>
                            <td><?php echo anchor('customer/orders/view/'. $order->id, '#'. $order->order_number); ?>
                            </td>
                            <td><?php echo get_formatted_date($order->order_date); ?></td>
                            <td><?php echo $order->total_items; ?>Jumlah Barang</td>
