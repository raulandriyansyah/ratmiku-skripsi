...
<div align="center">
    ...
    <div style="font-size: 20px" align="center">STRUCK BARANG
    </div>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card card-dark">
                    <div class="card-header">
                        <h5 class="card-heading">Data Penerima Barang</h5>
                    </div>
                    <div class="card-body p-0">
                        <table class="table table-hover table-striped table-hover">
                            <tr>
                    ...
                    <div class="card-body p-0">
                        <table class="table table-hover table-condensed">
                            <tr>
                                ...
                                <th scope="col">Jumlah Beli Barang</th>
                                <th scope="col">Harga satuan</th>
                                <th scope="col">Tanggal Barang Sampai</th>
                            </tr>
            ...
            <div class="col-md-4">
                ...
                <td style="width: 75%">
                    <!--<div class="zone" style="height: 40mm;vertical-align: middle; text-align: justify">
                        ...
                        tiket
                        dan bergabung liburan bersama vina tour and travel ini
