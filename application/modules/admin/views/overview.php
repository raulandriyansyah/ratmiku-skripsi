                    ...
                    <div class="card card-stats">
                        ...
                        <div class="card-body">
                            ...
                            <p class="mt-3 mb-0 text-sm">
                                ...
                                <span class="text-nowrap">Jumlah Katalog yang tersedia</span>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="list-group list-group-flush list my--3">
                        ...
                        <li class="list-group-item px-0">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    ...
                                    <a href="#" class="avatar rounded-circle">
                                        <img alt="Image placeholder"
                                            src="<?php echo base_url('assets/uploads/users/'. $customer->profile_picture); ?>">
                                    </a>
                                </div>
                                <div class="col ml--2">
                                    <h4 class="mb-0">
                                ...
                                <div class="col-auto">
                                    <a href="<?php echo site_url('admin/customers/view/'. $customer->id); ?>"
                                        class="btn btn-sm btn-primary">Profil</a>
                                </div>
                            </div>
                        </li>
                        <?php endforeach; ?>
                            ...
                            <div class="checklist-item checklist-item-info">
                                <div class="checklist-info">
                                    <h5 class="checklist-title mb-0">
                                        <?php echo anchor('admin/orders/view/'. $order->id, 'Order #'. $order->order_number); ?>
                                    </h5>
                                    <small><?php echo $order->total_items; ?></small> | <small>Rp
                                        <?php echo format_rupiah($order->total_price); ?></small>
                                </div>
                            </div>
                        </li>
                        <?php endforeach; ?>
        ...
        <div class="col-xl-8">
            <div class="card">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="mb-0">Paket baru</h3>
                        </div>
                        <div class="col text-right">
                            <a href="<?php echo site_url('admin/products'); ?>" class="btn btn-sm btn-primary">Lihat
                                semua</a>
                        </div>
                    </div>
                </div>
