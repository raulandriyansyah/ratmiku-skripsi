                ...
                <div class="col-lg-6 col-5 text-right">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><?php echo anchor('admin/customers', 'User Pendaftar'); ?></li>
            ...
            <div class="card-wrapper">
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0">Data User Pendaftar</h3>
                        <?php if ($flash) : ?>
                    ...
                    <div class="card-body p-0">
                        <table class="table align-items-center table-flush table-hover">
                            ...
                            <tr>
                                <td>Alamat</td>
                                <td>
                                    <div style="white-space: initial;"><b><?php echo $customer->address; ?></b></div>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="card-footer">
                        <a href="#" data-id="<?php echo $customer->id; ?>" class="btn btn-danger btn-sm btnDelete"><i
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.code == 204) {
                        ...
                        setTimeout(() => {
                            window.location =
                                '<?php echo site_url('admin/customers'); ?>';
                        }, 4000);
                    }
                }
            })
