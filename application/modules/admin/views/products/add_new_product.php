                ...
                <div class="col-lg-6 col-5 text-right">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/products'); ?>">Paket</a>
                            </li>
            ...
            <div class="card-wrapper">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label class="form-control-label" for="name">Nama paket:</label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="stock">Kuota Tersedia:</label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="unit" value="<?php echo set_value('unit'); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control"
                                id="desc"><?php echo set_value('description'); ?></textarea>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-footer text-right">
                    <input type="submit" value="Tambah Paket Baru" class="btn btn-primary">
                </div>
            </div>
        </div>
    </div>
