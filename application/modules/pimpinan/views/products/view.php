            ...
            <div class="card-wrapper">
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <div>
                            <img alt="<?php echo $product->name; ?>" class="img img-fluid rounded"
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td><b><?php echo $product->date_tour; ?></b></td>
                            </tr>
                            <tr>
                                <td>Kode Barang</td>
                                <td>:</td>
                            ...
                            <tr>
                                <td>Diskon</td>
                                <td>:</td>
                                <td><b>Rp <?php echo format_rupiah($product->current_discount); ?>
                                        (<?php echo count_percent_discount($product->current_discount, $product->price, 2); ?>
                                        %)</b></td>
                            </tr>
                            <tr>
                                <td>Kategori</td>
                                <td>:</td>
                                <td><b><?php echo anchor('admin/products?category_id='. $product->category_id, $product->category_name); ?></b>
                                </td>
                            </tr>
                            <tr>
