                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="<?php echo site_url('admin/products/view/'. $product->id); ?>"><?php echo $product->name; ?></a>
                            </li>
            ...
            <div class="card-wrapper">
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" class="form-control" id="package">
                                        ...
                                        <option value="<?php echo $category->id; ?>"
                                            <?php echo set_select('category_id', $category->id, ($product->category_id == $category->id) ? TRUE : FALSE); ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="price_discount"
                                            value="<?php echo set_value('price_discount', $product->current_discount); ?>"
                                            class="form-control" id="price_d">
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="stock"
                                        value="<?php echo set_value('stock', $product->stock); ?>" class="form-control"
                                        id="stock">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="unit"
                                        value="<?php echo set_value('unit', $product->product_unit); ?>"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label class="form-control-label" for="unit">Tanggal Tour:</label>
                                <input type="date" name="date_tour"
                                    value="<?php echo set_value('date_tour', $product->date_tour); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control"
                                id="desc"><?php echo set_value('description', $product->description); ?></textarea>
                            <?php echo form_error('description'); ?>
                        </div>

                        <div class="form-group">
                            <label for="av" class="form-control-label">
                                <input type="checkbox" id="av" name="is_available" value="1"
                                    <?php echo set_checkbox('is_available', $product->is_available, ($product->is_available == 1) ? TRUE : FALSE); ?>>
                            ...
                            <ul class="nav nav-pills mb-3 float-right" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link p-1 active" id="pills-current-tab" data-toggle="pill"
                                        href="#pills-current" role="tab" aria-controls="pills-home"
                                        aria-selected="true">Current</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link p-1" id="pills-edit-tab" data-toggle="pill" href="#pills-edit"
                                        role="tab" aria-controls="pills-profile" aria-selected="false">Ganti</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link p-1" id="pills-delete-tab" data-toggle="pill"
                                        href="#pills-delete" role="tab" aria-controls="pills-contact"
                                        aria-selected="false">Hapus</a>
                                </li>
                            </ul>
                        </div>
                        <?php endif; ?>
