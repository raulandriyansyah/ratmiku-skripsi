                ...
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="d-flex">
                        <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
                            <li><a href="<?php echo site_url('shop/cart'); ?>" class="py-2 d-block">Order</a></li>
                            <li><a href="<?php echo site_url('customer/payments/confirm'); ?>"
                                    class="py-2 d-block">Konfirmasi Pembayaran</a></li>
                            <li><a href="<?php echo site_url('shop/testimonial'); ?>" class="py-2 d-block">Testimoni
                                    Pelanggan</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon icon-map-marker"></span><span
                                    class="text"><?php echo get_settings('store_address'); ?></span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span
                                        class="text"><?php echo get_settings('store_phone_number'); ?></span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span
                                        class="text"><?php echo get_settings('store_email'); ?></span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
