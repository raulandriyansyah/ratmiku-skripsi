...
<div class="hero-wrap hero-bread"
    style="background-image: url('<?php echo get_theme_uri('images/ratmikubg.jpg'); ?>');">
    <div class="container">
...
<section class="ftco-section ftco-Keranjang Belanja">
    <div class="container">
                                ...
                                <tr class="text-center cart-<?php echo $item['rowid']; ?>">
                                    ...
                                    <td class="quantity">
                                        <div class="input-group mb-3">
                                            <input type="text" name="quantity[<?php echo $item['rowid']; ?>]"
                                                class="quantity form-control input-number"
                                                value="<?php echo $item['qty']; ?>" min="1" max="100">
                                        </div>
                                    </td>
        ...
        <div class="row">
            <div class="col-md-12 ftco-animate">
                <div class="alert alert-info">Tidak ada pesanan dalam
                    keranjang.<br><?php echo anchor('/', 'Jelajahi Katalog kami'); ?> dan mulailah booking!
                </div>
            </div>
        </div>
        <?php endif; ?>
