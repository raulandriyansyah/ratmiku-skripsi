          ...
          <div class="card-body box-profile">
            <div class="d-flex align-items-center">
              <div class="text-center" style="flex: 1;">
                <img class="profile-user-img img-fluid img-square" src="<?= get_user_image() ?>" alt="sodiokinon"
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-info">
            <div class="inner">
              ...
              <a href="http://localhost/ratmiku/member.php" class="small-box-footer">Lihat Reviews <i
